...
contract TestRegisterFlow is Test, Script, CodeConstants {
    ...
    function setUp() public {
        ...
        vm.prank(OWNER);
        proofOfPassportRegister.setVerifier(SIGNATURE_ALGORITHM_RSA_65537_SHA1, address(verifierProveRSA65537SHA1), NULLIFIER_INDEX_IN_PUB_SIGNAL);
        // vm.prank(OWNER);
    ...
    function testRegisterFlowSha256RSA65537(address recipient, address signer, address user) public {        
        ...
        uint256 nullifier = SHA256_RSA_65537_PROOF.pubSignals[proofOfPassportRegister.getNullifierIndex(SIGNATURE_ALGORITHM_RSA_65537_SHA256)];
    ...
    function testRegisterFlowSha1RSA65537(address recipient, address signer, address user) public {        
        ...
        address newSigner = makeAddr("newSigner");
        uint256 nullifier = SHA1_RSA_65537_PROOF.pubSignals[proofOfPassportRegister.getNullifierIndex(SIGNATURE_ALGORITHM_RSA_65537_SHA1)];
